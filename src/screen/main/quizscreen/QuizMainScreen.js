...
export default class QuizScreen extends Component {
  ...
  onLoad = () => {
    ...
    this.didFoucsSubscription = this.props.navigation.addListener(
      'focus',
      () => {
  ...
  initialQuizState = async () => {
    ...
    const getTodayQuizAnswerList = await getItemFromAsync(
      'todayQuizAnswerList',
    );
  ...
  CountDownQuizTimer = dt => {
    ...
    const showRemaining = () => {
      ...
      const _timerText = `${zeroSet(hours)}:${zeroSet(minutes)}:${zeroSet(
        seconds,
      )}`;
      ...
      return (
        <View>
          <Image
            ...
            source={require('assets/ic_jesus.png')}
          />
          ...
          <TouchableOpacity
            ...
            onPress={this.moveToScreen('TodayQuizScreen')}>
    ...
    // 복습퀴즈 데이터가 있으면 복습퀴즈와 링크, 바로가기를 보여준다.
      ...
      return (
        <ScrollView>
          ...
          <Image
            style={styles.todayQuizReviewImage}
            source={require('assets/ic_today_quiz_review.png')}
          />
    ...
    return (
      <View>
        <TouchableOpacity onPress={this.moveToScreen('TodayQuizCheckScreen')}>
          <Image
            style={styles.quizResultQuestionImage}
            source={require('assets/ic_question_quiz_result.png')}
          />
        </TouchableOpacity>
        <Image
          style={styles.quizResultJesusImage}
          source={require('assets/ic_jesus_weird.png')}
        />
  ...
  TodayQuizResultGiveUp = () => {
    return (
      <View>
        ...
        <Image
          style={styles.quizResultJesusImage}
          source={require('assets/ic_jesus_sad.png')}
        />
        <Text style={styles.titleText}>
          오늘의 세례문답{'\n'}퀴즈를 포기하셨네요.{'\n'}내일의 세례문답까지.
        </Text>
  ...
  render() {
    ...
    if (isCompleteTodayQuiz) {
      return (
        <SafeAreaView
          style={styles.completeQuizContainer}
